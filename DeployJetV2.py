...
class Ui_Window(QWidget):
    ...
    def retranslateUi(self, Window):
        ...
        for name in DATASETS:
            self.datasets[name] = ImageClassificationDataset(
